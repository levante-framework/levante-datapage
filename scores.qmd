...
```{ojs}
//| output: false
tag_vars = ["dataset", "site", "task_label", "language", "adaptive", "score_type", "scoring_model"]
...
ti = ({
  ...
  "site":          { label: "Team",          filter: true,  color: true,  tip: true  },
...
allowedDatasetNames = (ds) => {
  ...
  const extraDatasets = ["levante-data-latest"]
