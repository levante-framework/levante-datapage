...
::: {.info-text}
_Note: To change data sources, you need a [Redivis](https://redivis.com) account. Click on the button below to log into your Redivis account and list the datasets that you have access to._
:::
...
item_vars = ["item_group", "item_uid", "n_responses", "difficulty"] //"item_entry", "difficulty", 
  ...
  marginBottom: 40,
         ...
         marks: [
          Plot.dot(task_items, Plot.dodgeY("middle", {
            ...
            //channels: {...item_channels, "difficulty": "difficulty"}
          })),
        ]
})
```
 ...
 marginBottom: 40,
        ...
        marks: [
          Plot.dot(task_items, Plot.dodgeY("middle", {
            ...
            tip: { format: { fy: false }, anchor: "left" },
            channels: item_channels
            //channels: {...item_channels, "discrimination": "discrimination"}
          })),
        ]
})
```
