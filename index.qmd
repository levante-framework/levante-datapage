...
displayConfig = ([
  ...
  { index: 1, property: "site",         label: "Teams",        icon: "geo"            },
...
```{ojs}
y_var_opts = new Map([["Team", "site"], ["Dataset", "dataset"], ["Language", "language"], ["Task", "task_label"]])
viewof y_var = Inputs.select(y_var_opts, { label: "For each", value: "task_label" })
```

```{ojs}
color_opts = new Map([["", null], ["Team", "site"], ["Dataset", "dataset"], ["Language", "language"], ["Task", "task_label"]])
...
```{ojs}
stack_var_opts = new Map([["", null], ["Team", "site"], ["Dataset", "dataset"], ["Language", "language"], ["Task", "task_label"]])
